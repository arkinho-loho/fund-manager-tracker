...
1. 你想跟踪几位基金经理？（也可以选择"从数据中筛选"）
2. 输入他们的姓名和基金公司（或输入筛选条件）
...
```
"帮我从数据中发现值得关注的基金经理"
"找近1年收益前20%、最大回撤小于15%的科技方向经理"
"筛选管理规模超100亿、年化收益超15%的基金经理"
```

Skill 会通过同花顺问财按条件筛选，返回符合条件的经理名单，你可以从中挑选加入跟踪名单。
...
"帮我从数据中筛选出值得关注的经理"  → 条件筛选发现新经理（见上方）
```
